    ...
    <div className="row g-4">
      <div className="col-xxl-6 col-md-8">
        <div
          ...
          style={{
            backgroundImage: 'url("/assets/images/veg-3/home/1.png")'
          }}
        >
      ...
      <div className="col-xxl-3 col-md-4 ratio_medium d-md-block d-none">
        <div className="home-contain home-small h-100">
          <div
            ...
            style={{
              backgroundImage: 'url("/assets/images/veg-3/home/2.png")'
            }}
          >
          </div>
          ...
          <div className="col-xxl-12 col-sm-6">
            <div className="home-contain">
              <a
                ...
                style={{
                  backgroundImage: 'url("../assets/images/veg-3/home/3.png")'
                }}
              >
                <img
          ...
          <div className="col-xxl-12 col-sm-6">
            <div className="home-contain">
              <a
                ...
                className="bg-size blur-up lazyloaded main-banner-img"
                style={{
                  backgroundImage: 'url("../assets/images/veg-3/home/4.png")'
                }}
              >
                <img
